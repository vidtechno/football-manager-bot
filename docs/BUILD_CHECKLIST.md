...
- [ ] **4. Supabase poydevori va migratsiyalar (Supabase foundation and migrations)**
  ...
  - [ ] **4B2. Supabase League Clubs va Bot Tayinlovlari migratsiyasi (`create_league_clubs_and_bot_assignments`):** `league_clubs` va `bot_manager_assignments` jadvallari, LOBBY-only klub tanlash/almashtirish hamda bot biriktirish operatsiyalari uchun tranzaktsiyaviy RPC funksiyalari shakllantirildi.
