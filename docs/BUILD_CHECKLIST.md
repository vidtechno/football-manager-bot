...
- [ ] **4. Supabase poydevori va migratsiyalar (Supabase foundation and migrations)**
  ...
  - [ ] **4D. Supabase League Players va Club Finances migratsiyasi (`create_league_players_and_finances`):** `league_players`, `league_player_positions`, `club_finances`, hamda `financial_ledger` jadvallari, ishorali moliyaviy jurnal modellari, tenglashtiruvchi boshlang'ich byudjet va atomar moliya RPC funksiyalari shakllantirildi.
